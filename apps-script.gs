...
function setupDatabase() {
  ...
  const updateRows = [
    [
      ...
      "12/08/2026",
      "user",
      "อัปเดตหน้าลงเวลาให้ลื่นขึ้น",
      "มีตัวเลขนับถอยหลังบอกเวลารอระหว่างตรวจสอบสถานะ|เชื่อมต่อช้าระบบลองใหม่ให้อัตโนมัติ ก่อนให้กดเอง|เปิดแอปซ้ำเห็นสถานะทันทีไม่ต้องรอโหลด|แก้อาการตรวจสอบวนซ้ำถี่ ๆ เวลาสลับแอปไปมา",
      true,
    ],
    [
      APP_VERSION,
      ...
      "ลดจำนวนคำขอซ้ำจากหน้าลงเวลา (รวม request คู่ขนานเป็นเส้นเดียว)|อุ่นเครื่องเซิร์ฟเวอร์ตั้งแต่หน้าล็อกอิน ลดอาการช้าครั้งแรก|เพิ่ม cache ประวัติรายพนักงานพร้อมล้างอัตโนมัติเมื่อลงเวลา",
      true,
    ],
  ];
